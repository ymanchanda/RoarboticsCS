...
@Autonomous(name = "Blue Right Obs", group = "Pixel")
public class BlueRightITDOBS extends LinearOpMode { //updated
    ...
    static final Vector2d path1 = new Vector2d(-55.5, 56.3);
    static final Vector2d path2 = new Vector2d(-63.9,-60); //observation zone
    ...
    Pose2d startPoseBR = new Pose2d(-64.3, -15.7);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (currentState) {
                ...
                case PARK://parks in observation zone
                    ...
                    currentState = BlueRightITDOBS.State.IDLE;
                    break;
