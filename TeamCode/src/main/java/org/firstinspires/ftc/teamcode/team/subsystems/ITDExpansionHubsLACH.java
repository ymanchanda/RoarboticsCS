...
public class ITDExpansionHubsLACH implements ISubsystem {
    ...
    public ITDExpansionHubsLACH(ITDAutoRobotLACH robot, ExpansionHubEx masterHub, ExpansionHubEx slaveHub) {
        setRobot(robot);
